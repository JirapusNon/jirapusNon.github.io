import { TRUST_SERVICES } from '@/lib/constants';
      ...
      {TRUST_SERVICES.map((service) => {
        ...
        return (
          ...
          >
            ...
            <span className="trust-badge__body">
              <span className="trust-badge__label">{service.label}</span>
              <span className="trust-badge__desc">{service.description}</span>
            </span>
          </li>
        );
      })}
