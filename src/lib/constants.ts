...
export const CONTACT = {
  ...
  email: 'rnkproducts@hotmail.com',
  address: '21/22 หมู่ 4 ต.บางพลีใหญ่ อ.บางพลี จ.สมุทรปราการ 10540',
  addressShort: 'บางพลี, สมุทรปราการ',
  mapUrl: 'https://maps.app.goo.gl/3kPTHRAwZ9YVwBfH7',
  mapEmbedSrc:
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3877.769309918181!2d100.6895701!3d13.610896799999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x311d5ebfa9b47f17%3A0x3d6a06d7284558b7!2z4Lia4LiI4LiBLiDguK3guLLguKPguYwg4LmA4Lit4LmH4LiZIOC5gOC4hCDguYLguJvguKPguJTguLHguIHguKrguYw!5e0!3m2!1sen!2sth!4v1784548335283!5m2!1sen!2sth',
};

export const BUSINESS = {
  legalName: 'บริษัท อาร์ เอ็น เค โปรดักส์ จำกัด (สำนักงานใหญ่)',
  legalNameEn: 'R N K PRODUCTS CO., LTD.',
  taxId: '0115558012101',
  foundedYear: 2010,
  responseTime: 'ตอบ LINE ภายใน 30 นาที',
  ...
  about: [
    ...
    'มีสต็อกพร้อมส่งจากคลังในบางพลี สมุทรปราการ ทีมงานช่วยเช็กรุ่นหมึกที่ตรงกับเครื่องพิมพ์ของคุณ สั่งซ้ำได้สะดวกผ่าน LINE',
  ...
  aboutExtended: [
    'เริ่มจากการจำหน่ายหมึกพิมพ์ให้ร้านค้าและสำนักงานในพื้นที่บางพลี สมุทรปราการ ก่อนขยายบริการจัดส่งทั่วประเทศ ปัจจุบันมีสต็อกหมึกแท้ หมึกเทียบเท่า โทนเนอร์ และอุปกรณ์สำนักงานครบหลายร้อยรุ่น',
  ...
  values: [
    'สต็อกพร้อมส่งจากคลังบางพลี สมุทรปราการ',
...
export const FOOTER = {
  ...
  tagline:
    'บริษัท อาร์ เอ็น เค โปรดักส์ จำกัด ผู้แทนจำหน่าย หมึกแท้และหมึกรีเมนูทุกรุ่น',
  lineButton: 'แชท LINE',
...
export const STORE = {
  eyebrow: 'คลังสินค้า · บางพลี สมุทรปราการ',
